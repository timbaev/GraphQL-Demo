...
public class WebError: Error {
    ...
    public static let notAcceptable = WebError(code: .notAcceptable)
    public static let unprocessableEntity = WebError(code: .unprocessableEntity)
    ...
    public var logDescription: String {
        ...
        case WebError.notAcceptable:
            description = "WebError.notAcceptable"

        case WebError.unprocessableEntity:
            description = "WebError.unprocessableEntity"
    ...
    public var detailDescription: String? {
        ...
        guard let detailDescription = data["error"] as? String else {
            return nil
        }
    ...
    public convenience init?(fromStatusCode statusCode: Int, data: Any?) {
        ...
        case 406:
            self.init(code: .notAcceptable, base: WebStatusCode(rawValue: statusCode), data: data)

        case 422:
            self.init(code: .unprocessableEntity, base: WebStatusCode(rawValue: statusCode), data: data)
